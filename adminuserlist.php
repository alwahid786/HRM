...
$stmt = $conn->prepare("SELECT id, username, login, email, user_type, hiring_date, created_at, status, leave_limit, leave_start_date, leave_end_date 
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background: linear-gradient(to right, #35592d, #1e5d75) !important; color: #fff;">
            <div class="modal-header">
                <h5 class="modal-title" id="leavelimitModalLabel">Leave Limit</h5>
