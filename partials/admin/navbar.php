...
<body>
    ...
    <nav class="navbar navbar-expand-lg  fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="admin.php"><img src="images/icons/menu.png" width="25px" height="25px"></a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdownbg ">
                            ...
                            <li><a class="dropdown-item" href="efficiencyCategories.php">Efficiency Categories</a></li>
                            <li><a class="dropdown-item" href="efficiency.php">Employee's Efficiency</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="adminapproval.php">
                            Approval
    ...
    <div class="modal fade style=" id="changePasswordModal" tabindex="-1" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            ...
                            <input style="background-color: #216891;" type="password" class="form-control" id="newPassword" name="newPassword" required>
                        </div>
